package com.suurflieg.theworldbefore.custom.block.block.geodes;
...
public class SpectroliteBlock extends Block {

    public SpectroliteBlock(Properties pProperties) {
        super(pProperties);
    }
